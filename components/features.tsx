...
// import Video from "@/public/videos/DUT Handler.mp4";
...
<div className="flex items-center justify-between pb-4 md:pb-12" data-aos="fade-up">
    ...
    />
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            ...
            <svg
              ...
              L'IA et le machine learning permettent une reconnaissance autonome des objets, offrant précision et adaptabilité.
              </p>
            </article>
            <article>
            <svg
              ...
              <p className="text-indigo-200/65">
              Léger et facile à déplacer en quelques minutes, sans besoin d'équipement spécial, il s'adapte à différents environnements.
              </p>
            </article>
            <article>
            <svg
              ...
              <p className="text-indigo-200/65">
              Aucune configuration requise, il détecte et teste instantanément pour une utilisation immédiate et sans effort.
              </p>
            </article>
            <article>
            <svg
              ...
              <p className="text-indigo-200/65">
              Le modèle de location innovant permet une adoption rapide et sans contrainte, tout en optimisant les coûts.
              </p>
            </article>
            <article>
            <svg
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">
              Interopérabilité avancée              </h3>
              <p className="text-indigo-200/65">
              Il communique facilement avec d'autres machines, suivant les normes du marché pour une intégration fluide.
              </p>
            </article>
            <article>
            <svg
              ...
              <p className="text-indigo-200/65">
              Assistance à distance et intervention rapide pour garantir une prise en charge réactive et continue.
              </p>
            </article>
          </div>
